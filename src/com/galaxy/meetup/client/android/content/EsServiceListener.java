...
// Referenced classes of package com.google.android.apps.plus.service:
//            ServiceResult
...
public class EsServiceListener {
	...
	public void onAccountAdded(int i, EsAccount esaccount,
			ServiceResult serviceresult) {
	}

	public void onAccountUpgraded(int i, EsAccount esaccount,
			ServiceResult serviceresult) {
	}

	public void onAddPeopleToCirclesComplete(int i, ServiceResult serviceresult) {
	}

	public void onChangeNotificationsRequestComplete(EsAccount esaccount,
			ServiceResult serviceresult) {
	}
	...
	public void onCreateCircleRequestComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onCreatePhotoCommentComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onDeletePhotoCommentsComplete(int i, ServiceResult serviceresult) {
	}

	public void onDeletePhotosComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onEditPhotoCommentComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onGetActivity(int i, String s, ServiceResult serviceresult) {
	}

	public void onGetActivityAudience(int i, AudienceData audiencedata,
			ServiceResult serviceresult) {
	}
	...
	public void onGetPhotosOfUserComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onGetStreamPhotosComplete(int i, ServiceResult serviceresult) {
	}

	public void onImageThumbnailUploaded(int i, String s) {
	}

	public void onInsertCameraPhotoComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onMutateProfileComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onPlusOneComment(boolean flag, ServiceResult serviceresult) {
	}
	...
	public void onReadSquareMembersComplete(int i, AudienceData audiencedata,
			ServiceResult serviceresult) {
	}

	public void onRemovePeopleRequestComplete(int i, ServiceResult serviceresult) {
	}

	public void onReportAbuseRequestComplete(int i, ServiceResult serviceresult) {
	}

	public void onReportActivity(int i, ServiceResult serviceresult) {
	}

	public void onReportPhotoCommentsComplete(int i, String s, boolean flag,
			ServiceResult serviceresult) {
	}

	public void onReportPhotoComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onSearchActivitiesComplete(int i, ServiceResult serviceresult) {
	}

	public void onSendEventRsvpComplete(int i, ServiceResult serviceresult) {
	}

	public void onSetBlockedRequestComplete(int i, ServiceResult serviceresult) {
	}

	public void onSetCircleMembershipComplete(int i, ServiceResult serviceresult) {
	}

	public void onSetCoverPhotoComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onSetScrapbookInfoComplete(int i, ServiceResult serviceresult) {
	}
	...
	public void onUploadCoverPhotoComplete(int i, ServiceResult serviceresult) {
	}

	public void onUploadProfilePhotoComplete(int i, ServiceResult serviceresult) {
	}
